...
var Circle=function(t,i,o,r){this.x=t,this.y=i,this.r=o,this.color=r,this.handlers={}};Circle.prototype.moveTo=function(t,i){this.x=t,this.y=i},Circle.prototype.moveBy=function(t,i){this.x+=t,this.y+=i},Circle.prototype.moveToward=function(t,i,o){var r=t-this.x,e=i-this.y,h=Math.sqrt(r*r+e*e);0!==h&&(this.x+=o*r/h,this.y+=o*e/h)},Circle.prototype.movePolar=function(t,i){this.x+=t*Math.cos(i),this.y-=t*Math.sin(i)},Circle.prototype.search=function(t,i,o){var r=t-this.x,e=i-this.y,h=this.r+o,s=h;return s*s>r*r+e*e?[this]:null},Circle.prototype.on=function(t,i){this.handlers[t]=i},Circle.prototype.off=function(t){delete this.handlers[t]},Circle.prototype.draw=function(t){t.beginPath(),t.arc(this.x,this.y,this.r,0,2*Math.PI,!1),t.fillStyle=this.color,t.fill()},module.exports=Circle;
},{}],3:[function(require,module,exports){
var Hammer=require("hammerjs"),World=require("./world"),Group=require("./group"),Circle=require("./circle"),makeCanvasAutoFullwindow=function(e){var t=function(){e.width=window.innerWidth,e.height=window.innerHeight};window.addEventListener("resize",t,!1),t()},Circles=function(){var e=new World,t=!0,n=null,r={},i=this,o=document.createElement("canvas");o.style.position="fixed",o.style.top="0px",o.style.right="0px",o.style.display="block",o.style.margin="0",o.style.width="100%",o.style.height="100%",document.body.appendChild(o);var a=o.getContext("2d"),s=new Hammer(o);s.on("tap",function(t){var n,o,a,s,l;if(n=t.center.x,o=t.center.y,s=e.search(n,o,0),s.length>0)for(a=0;a<s.length;a+=1)l=s[a],l.handlers.hasOwnProperty("tap")&&l.handlers.tap.call(l,l,n,o);else r.hasOwnProperty("tap")&&r.tap.call(i,i,n,o)}),makeCanvasAutoFullwindow(o);var l=function h(){var r,i;r=Date.now(),i=null===n?0:r-n,n=r,e.draw(a,o.width,o.height),t&&window.requestAnimationFrame(h)},c=function(){t||(t=!0,l())},d=function(){t=!1};t&&l(),this.createCircle=function(t,n,r,i){var o=new Circle(t,n,r,i);return e.add(o),o},this.searchInside=function(t,n,r){return e.search(t,n,r)},this.on=function(e,t){r[e]=t},this.off=function(e){delete r[e]},this.start=c,this.stop=d};exports.createWorld=function(e,t){return new Circles(e,t)},exports.extension=Circles.prototype,exports.version="0.2.0";
},{"./circle":2,"./group":4,"./world":5,"hammerjs":1}],4:[function(require,module,exports){
var Group=function(){this.items=[]};Group.prototype.add=function(t){this.items.push(t)},Group.prototype.search=function(t,r,o){var e,i,s,p;for(e=[],s=0;s<this.items.length;s+=1)if(i=this.items[s].search(t,r,o),null!==i)for(p=0;p<i.length;p+=1)e.push(i[p]);return e},Group.prototype.draw=function(t){for(var r=0;r<this.items.length;r+=1)this.items[r].draw(t)},module.exports=Group;
},{}],5:[function(require,module,exports){
var Group=require("./group"),World=function(){};World.prototype=new Group,World.prototype.draw=function(o,r,p){o.clearRect(0,0,r,p),Group.prototype.draw.call(this,o)},module.exports=World;
},{"./group":4}]},{},[3])(3)
});


//# sourceMappingURL=circles.min.js.map